...
import { MoneyCollectOutlined, DollarCircleOutlined, FundOutlined, ExclamationCircleOutlined, NumberOutlined, StopOutlined, ThunderboltOutlined, TrophyOutlined } from '@ant-design/icons';
...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    { title: 'All-time-high(daily avg.)', value: `$ ${cryptoDetails.all && millify(cryptoDetails.allTimeHigh.price)}`, icon: <TrophyOutlined /> },
